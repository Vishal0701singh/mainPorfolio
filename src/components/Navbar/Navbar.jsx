...
const Navbar = ({offset, setOffset,preOffset}) => {
  ...
  // const isShow= (offset<preOffset)&&(offset>100)?'positionFixed':'positionAbs';
  const isShow= (offset>0)?'positionFixed':'';
  // console.log(isShow);
  // const isShow= 'positionFixed';
  ...
  return (
    <div className={`navbar ${isShow}`} id="home">
